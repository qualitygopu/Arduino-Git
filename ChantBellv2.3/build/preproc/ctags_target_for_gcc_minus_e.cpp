# 1 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
# 2 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 2
# 3 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 2
# 4 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 2
# 5 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 2
# 6 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 2
# 7 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 2
# 8 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 2
# 9 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 2
# 10 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 2
...
unsigned long timrAmp, timrLCD, timr_Time, timrMNU, timr_Song;
...
# 94 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 94 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
             "QTRON"
# 94 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
             ); &__c[0];}))
# 94 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
    ...
    lcd.setCursor(0, 1);
    lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 96 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 96 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
             "DEVOTIONAL CLOCK"
# 96 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
             ); &__c[0];}))
# 96 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
    ...
    while (!rtc.begin())
    {
        lcd.clear();
        lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 123 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 123 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
                 "ERR 01"
# 123 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
                 ); &__c[0];}))
# 123 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
    ...
    if (!rtc.isrunning())
    {
        lcd.clear();
        lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 131 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 131 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
                 "ERR 02"
# 131 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
                 ); &__c[0];}))
# 131 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
    ...
    // if (digitalRead(BACK_BUT))
    {
        ...
        while (!myDFPlayer.begin(mySoftwareSerial))
        {
            lcd.setCursor(0, 0);
            lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 142 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
                     (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 142 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
                     "ERR 03"
# 142 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
                     ); &__c[0];}))
# 142 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
    ...
    if (!digitalRead(6) && !digitalRead(7))
    {
        ...
        while (true)
        {
            ...
            lcd.setCursor(0, 0);
            lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 187 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
                     (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 187 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
                     " ENTER PASSWORD "
# 187 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
                     ); &__c[0];}))
# 187 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
...
void loop()
{
    ...
    case APP_DEMO_MODE:
    {
        lcd.setCursor(0, 0);
        lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 320 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 320 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
                 "  RUNNING DEMO  "
# 320 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
                 ); &__c[0];}))
# 320 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
...
byte processMenuCommand(byte cmdId)
{
    ...
    case mnuCmdSlogamCount:
    {
        ...
        if (btn == (2 | (0 << 6)) || btn == (2 | (2 << 6)))
        {
            config.Slog1_Count = ++config.Slog1_Count;
        }
        else if (btn == (3 | (0 << 6)) || btn == (3 | (2 << 6)))
        {
            config.Slog1_Count = --config.Slog1_Count < 0 ? 100 : config.Slog1_Count;
        }
        else if (btn == (1 | (0 << 6)) /*1*/)
        {
            config.save();
            ...
            else
            {
                if (cmdId == mnuCmdSetTime)
                {
                    ...
                    if (blinkMode == setMin)
                        lcd.setCursor(4, 1);
                    lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 955 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
                             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 955 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
                             "  "
# 955 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
                             ); &__c[0];}))
# 955 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
                ...
                else if (cmdId == mnuCmdSetDate)
                {
                    ...
                    if (blinkMode == setYear)
                        lcd.setCursor(9, 1);
                    lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 966 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
                             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 966 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
                             "  "
# 966 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino" 3
                             ); &__c[0];}))
# 966 "e:\\Arduino\\Arduino Git\\ChantBellv2.3\\ChantBellv2.3.ino"
...
void PlayChant()
{
        ...
        if (digitalRead(4))
        {
            ...
            else if ((config.EveSong1Time + 12) == bell.hour() && (config.EveSong1Time != 3))
            {
                ...
                playSong = End_of_Song;
                    ...
                    ((config.EveSong2Time + 12) == bell.hour() && (config.EveSong2Time != 3)))
            {
                myDFPlayer.playFolder(4, random(1,config.SongCount));
                delay(1000);
                if (timr_Song + config.songDuration > millis()/60000L)
                    playSong = Song_1;
                else
                    playSong = End_of_Song;
            }
            ...
            {
                if (config.Slog1_Count != 0)
                {
                    myDFPlayer.playMp3Folder(random(1, config.Slog1_Count));
                    delay(1000);
                    if (config.Slog2_Count != 0)
                        playSong = Song_2;
                    else
                        playSong = End_of_Song;
                }
    ...
    case Song_2:
        if (digitalRead(4))
        {
            myDFPlayer.playFolder(6, random(1, config.Slog2_Count));
            delay(1000);
            playSong = End_of_Song;
        }
        break;
