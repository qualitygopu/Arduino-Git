# 1 "e:\\Arduino\\Arduino Git\\ChantBellv2.2_ESP32\\ChantBellv2.2_ESP32.ino"
# 2 "e:\\Arduino\\Arduino Git\\ChantBellv2.2_ESP32\\ChantBellv2.2_ESP32.ino" 2
# 3 "e:\\Arduino\\Arduino Git\\ChantBellv2.2_ESP32\\ChantBellv2.2_ESP32.ino" 2
# 4 "e:\\Arduino\\Arduino Git\\ChantBellv2.2_ESP32\\ChantBellv2.2_ESP32.ino" 2
# 5 "e:\\Arduino\\Arduino Git\\ChantBellv2.2_ESP32\\ChantBellv2.2_ESP32.ino" 2
# 6 "e:\\Arduino\\Arduino Git\\ChantBellv2.2_ESP32\\ChantBellv2.2_ESP32.ino" 2
# 7 "e:\\Arduino\\Arduino Git\\ChantBellv2.2_ESP32\\ChantBellv2.2_ESP32.ino" 2
# 8 "e:\\Arduino\\Arduino Git\\ChantBellv2.2_ESP32\\ChantBellv2.2_ESP32.ino" 2
# 9 "e:\\Arduino\\Arduino Git\\ChantBellv2.2_ESP32\\ChantBellv2.2_ESP32.ino" 2
# 10 "e:\\Arduino\\Arduino Git\\ChantBellv2.2_ESP32\\ChantBellv2.2_ESP32.ino" 2
# 11 "e:\\Arduino\\Arduino Git\\ChantBellv2.2_ESP32\\ChantBellv2.2_ESP32.ino" 2



long ampDelay = 5000, menuTimeOut = 30000;
unsigned long timrAmp, timrLCD, timr_Time, timrMNU;
SoftwareSerial mySoftwareSerial(27, 14); // TX, RX
...
void setup()
{
    ...
    lcd.backlight();
    lcd.setCursor(5, 0);
    lcd.print(((reinterpret_cast<const __FlashStringHelper *>(("QTRON")))));
    lcd.setCursor(0, 1);
    lcd.print(((reinterpret_cast<const __FlashStringHelper *>(("DEVOTIONAL CLOCK")))));
    delay(2000);
    lcd.clear();
    lcd.setCursor(0, 0);
    ...
    {
        lcd.clear();
        lcd.print(((reinterpret_cast<const __FlashStringHelper *>(("ERR 01"))))); // Couldn't find RTC
    }
    ...
    {
        lcd.clear();
        lcd.print(((reinterpret_cast<const __FlashStringHelper *>(("ERR 02")))));
        delay(2000);
    }
    ...
    if (digitalRead(33))
    {
        ...
        {
            lcd.setCursor(0, 0);
            lcd.print(((reinterpret_cast<const __FlashStringHelper *>(("ERR 03")))));
        }
...
void loop()
{
    ...
    {
        lcd.setCursor(0, 0);
        lcd.print(((reinterpret_cast<const __FlashStringHelper *>(("  RUNNING DEMO  ")))));
        lcd.setCursor(0, 1);
