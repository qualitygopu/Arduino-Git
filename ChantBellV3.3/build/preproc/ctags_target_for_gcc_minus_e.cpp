# 1 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
# 2 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 2
# 3 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 2
# 4 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 2
# 5 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 2
# 6 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 2
# 7 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 2
# 8 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 2
# 9 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 2
# 10 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 2
# 19 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
...
# 113 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 113 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
             "QTRON"
# 113 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
             ); &__c[0];}))
# 113 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
    ...
    lcd.setCursor(0, 1);
    lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 115 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 115 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
             "DEVOTIONAL CLOCK"
# 115 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
             ); &__c[0];}))
# 115 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
    ...
    while (!rtc.begin())
    {
        lcd.clear();
        lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 141 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 141 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
                 "ERR 01"
# 141 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                 ); &__c[0];}))
# 141 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
    ...
    if (!rtc.isrunning())
    {
        lcd.clear();
        lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 147 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 147 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
                 "ERR 02"
# 147 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                 ); &__c[0];}))
# 147 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
    ...
    // if (digitalRead(BACK_BUT))
    {
        ...
        while (!myDFPlayer.begin(mySoftwareSerial))
        {
            ...
            lcd.setCursor(0, 0);
            lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 161 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                     (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 161 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
                     "ERR 03"
# 161 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                     ); &__c[0];}))
# 161 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
    ...
    if (!digitalRead(6) && !digitalRead(7))
    {
        ...
        while (true)
        {
            ...
            lcd.setCursor(0, 0);
            lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 209 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                     (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 209 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
                     " ENTER PASSWORD "
# 209 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                     ); &__c[0];}))
# 209 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
    ...
    if (btn == (2 | (2 << 6)))
    {
        if (!ButLongPress)
        {
            if (config.AutoPlay == 0)
            {
                ...
                lcd.setCursor(0, 1);
                lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 265 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 265 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
                         "  AUTO PLAY ON  "
# 265 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                         ); &__c[0];}))
# 265 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
            ...
            else
            {
                ...
                lcd.setCursor(0, 1);
                lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 271 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 271 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
                         " AUTO PLAY OFF  "
# 271 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                         ); &__c[0];}))
# 271 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
    ...
    if (btn == (3 | (2 << 6)))
    {
        if (!ButLongPress)
        {
            if (config.AutoLight == 0)
            {
                ...
                lcd.setCursor(0, 1);
                lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 288 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 288 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
                         " AUTO LIGHT ON  "
# 288 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                         ); &__c[0];}))
# 288 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
            ...
            else
            {
                ...
                lcd.setCursor(0, 1);
                lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 294 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 294 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
                         " AUTO LIGHT OFF "
# 294 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                         ); &__c[0];}))
# 294 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
    ...
    case APP_DEMO_MODE:
    {
        lcd.setCursor(0, 0);
        lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 431 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 431 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
                 "  RUNNING DEMO  "
# 431 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                 ); &__c[0];}))
# 431 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
    ...
    case APP_PLAYER_MODE:
    {
        ...
        lcd.setCursor(0, 1);
        lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 577 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 577 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
                 " PLAYER MODE ON "
# 577 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                 ); &__c[0];}))
# 577 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
            ...
            else
            {
                    ...
                    cmdId == mnuCmdPlrEveDur)
                {
                    ...
                    if (blinkMode == setMin)
                        lcd.setCursor(4, 1);
                    lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 1340 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 1340 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
                             "  "
# 1340 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                             ); &__c[0];}))
# 1340 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
                ...
                else if (cmdId == mnuCmdSetDate)
                {
                    ...
                    if (blinkMode == setYear)
                        lcd.setCursor(9, 1);
                    lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 1351 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 1351 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
                             "  "
# 1351 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino" 3
                             ); &__c[0];}))
# 1351 "e:\\Arduino\\Arduino Git\\ChantBellV3.3\\ChantBellV3.3.ino"
