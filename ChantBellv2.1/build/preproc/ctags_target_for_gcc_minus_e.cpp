# 1 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
# 2 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 2
# 3 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 2
# 4 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 2
# 5 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 2
# 6 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 2
# 7 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 2
# 8 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 2
# 9 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 2
# 10 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 2
...
# 77 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 77 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
             "QTRON"
# 77 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
             ); &__c[0];}))
# 77 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
    ...
    lcd.setCursor(0, 1);
    lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 79 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 79 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
             "DEVOTIONAL CLOCK"
# 79 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
             ); &__c[0];}))
# 79 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
    ...
    while (!r b tc.begin())
    {
        lcd.clear();
        lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 106 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 106 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
                 "ERR 01"
# 106 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
                 ); &__c[0];}))
# 106 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
    ...
    if (!rtc.isrunning())
    {
        lcd.clear();
        lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 114 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 114 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
                 "ERR 02"
# 114 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
                 ); &__c[0];}))
# 114 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
    ...
    if (digitalRead(9))
    {
        ...
        while (!myDFPlayer.begin(mySoftwareSerial))
        {
            lcd.setCursor(0, 0);
            lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 126 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
                     (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 126 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
                     "ERR 03"
# 126 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
                     ); &__c[0];}))
# 126 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
...
void loop()
{
    ...
    case APP_DEMO_MODE:
    {
        lcd.setCursor(0, 0);
        lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 305 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 305 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
                 "  RUNNING DEMO  "
# 305 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
                 ); &__c[0];}))
# 305 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
            ...
            else
            {
                if (cmdId == mnuCmdSetTime)
                {
                    ...
                    if (blinkMode == setMin)
                        lcd.setCursor(4, 1);
                    lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 828 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
                             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 828 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
                             "  "
# 828 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
                             ); &__c[0];}))
# 828 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
                ...
                else if (cmdId == mnuCmdSetDate)
                {
                    ...
                    if (blinkMode == setYear)
                        lcd.setCursor(9, 1);
                    lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 839 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
                             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 839 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
                             "  "
# 839 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino" 3
                             ); &__c[0];}))
# 839 "e:\\Arduino\\Arduino Git\\ChantBellv2.1\\ChantBellv2.1.ino"
