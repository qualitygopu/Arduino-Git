#include <Arduino.h>
#line 1 "e:\\Arduino\\Arduino Git\\ChantBell_IR\\ChantBell_IR.ino"
#include <Wire.h>
#include "RTClib.h"
...
#line 61 "e:\\Arduino\\Arduino Git\\ChantBell_IR\\ChantBell_IR.ino"
void setup();
#line 131 "e:\\Arduino\\Arduino Git\\ChantBell_IR\\ChantBell_IR.ino"
void loop();
#line 966 "e:\\Arduino\\Arduino Git\\ChantBell_IR\\ChantBell_IR.ino"
byte getIRButton();
#line 61 "e:\\Arduino\\Arduino Git\\ChantBell_IR\\ChantBell_IR.ino"
void setup()
{
...
byte getIRButton()
{
    ...
    if (irrecv.decode(&results))
    {
        ...
        {
        case HASH:
            btnval = BUTTON_SELECT_LONG_PRESSED;
            break;
        case UP:
            btnval = BUTTON_UP_PRESSED;
            break;
        case DOWN:
            btnval = BUTTON_DOWN_PRESSED;
            break;
        case LEFT:
            btnval = BUTTON_LEFT_PRESSED;
            break;
        case RIGHT:
            btnval = BUTTON_RIGHT_PRESSED;
            break;
        case OK:
            btnval = BUTTON_SELECT_PRESSED;
            break;
        default:
        btnval = 0;
            break;
