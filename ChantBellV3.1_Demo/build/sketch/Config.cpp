#line 1 "e:\\Arduino\\Arduino Git\\ChantBellV3.1_Demo\\Config.cpp"
#include "Config.h"
#include "LcdKeypad.h"
#include "MenuData.h"
#include <avr/eeprom.h>
short StDate, StMonth, StYear, StHr, StMin, demoTime = 5, voiceNo = 0, demoSongNo = 1;
static char strbuf[LCD_COLS + 1];
const char NotImp[] = "-----";
const char* gods[] = {"Amman", "Vinayagar", "Sivan", "Perumal", "Murugan", "Veeran", "Ayyanar"};
