# 1 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
# 2 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 2
# 3 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 2
# 4 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 2
# 5 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 2
# 6 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 2
# 7 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 2
# 8 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 2
# 9 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 2
# 10 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 2
# 19 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
long CurTime;
...
# 98 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 98 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
             "QTRON"
# 98 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
             ); &__c[0];}))
# 98 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
    ...
    lcd.setCursor(0, 1);
    lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 100 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 100 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
             "DEVOTIONAL CLOCK"
# 100 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
             ); &__c[0];}))
# 100 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
    ...
    lcd.print(fmt(strbuf, 2, "Ver : 3.1/", intstr));
    lcd.setCursor(0,1);
    ...
    while (!rtc.begin())
    {
        lcd.clear();
        lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 126 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 126 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
                 "ERR 01"
# 126 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                 ); &__c[0];}))
# 126 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
    ...
    if (!rtc.isrunning())
    {
        lcd.clear();
        lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 132 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 132 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
                 "ERR 02"
# 132 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                 ); &__c[0];}))
# 132 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
    ...
    if (digitalRead(8))
    {
        ...
        while (!myDFPlayer.begin(mySoftwareSerial))
        {
            ...
            lcd.setCursor(0, 0);
            lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 147 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                     (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 147 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
                     "ERR 03"
# 147 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                     ); &__c[0];}))
# 147 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
    ...
    if (btn == (2 | (2 << 6)))
    {
        if (!ButLongPress)
        {
            if (config.AutoPlay == 0)
            {
                ...
                lcd.setCursor(0, 1);
                lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 187 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 187 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
                         "  AUTO PLAY ON  "
# 187 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                         ); &__c[0];}))
# 187 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
            ...
            else
            {
                ...
                lcd.setCursor(0, 1);
                lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 193 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 193 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
                         " AUTO PLAY OFF  "
# 193 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                         ); &__c[0];}))
# 193 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
    ...
    if (btn == (3 | (2 << 6)))
    {
        if (!ButLongPress)
        {
            if (config.AutoLight == 0)
            {
                ...
                lcd.setCursor(0, 1);
                lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 210 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 210 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
                         " AUTO LIGHT ON  "
# 210 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                         ); &__c[0];}))
# 210 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
            ...
            else
            {
                ...
                lcd.setCursor(0, 1);
                lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 216 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 216 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
                         " AUTO LIGHT OFF "
# 216 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                         ); &__c[0];}))
# 216 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
    ...
    case APP_DEMO_MODE:
    {
        lcd.setCursor(0, 0);
        lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 532 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 532 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
                 "  RUNNING DEMO  "
# 532 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                 ); &__c[0];}))
# 532 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
    ...
    case APP_PLAYER_MODE:
    {
        ...
        lcd.setCursor(0, 1);
        lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 563 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 563 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
                 " PLAYER MODE ON "
# 563 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                 ); &__c[0];}))
# 563 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
            ...
            else
            {
                    ...
                    cmdId == mnuCmdPlrEveDur)
                {
                    ...
                    if (blinkMode == setMin)
                        lcd.setCursor(4, 1);
                    lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 1376 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 1376 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
                             "  "
# 1376 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                             ); &__c[0];}))
# 1376 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
                ...
                else if (cmdId == mnuCmdSetDate)
                {
                    ...
                    if (blinkMode == setYear)
                        lcd.setCursor(9, 1);
                    lcd.print((reinterpret_cast<const __FlashStringHelper *>(
# 1387 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 1387 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
                             "  "
# 1387 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino" 3
                             ); &__c[0];}))
# 1387 "e:\\Arduino\\Arduino Git\\ChantBellV3.1\\ChantBellV3.1.ino"
